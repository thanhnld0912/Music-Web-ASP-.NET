...
using MusicWeb.Data;  // Đảm bảo đúng namespace của ApplicationDbContext
using MusicWeb.Models; // Nếu có Model Playlist, Post

namespace MusicWeb.Components
{
    public class GlobalPlayerViewComponent : ViewComponent
    {
        private readonly ApplicationDbContext _context;

        public GlobalPlayerViewComponent(ApplicationDbContext context)
        {
            _context = context;
        }
